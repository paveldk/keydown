...
hello.init({
	'bitbucket': {
		...
		oauth: {
			...
			request: 'https://bitbucket.org/api/1.0/oauth/request_token',
			token: 'https://bitbucket.org/api/1.0/oauth/access_token'
		},
		uri: {
			base: "https://bitbucket.org/api/1.0/",
			me: "https://bitbucket.org/api/1.0/user/"
		},
		wrap: {
			me: function (o) {
