(function () {
    ...
    SiteController = function (param) {
        ...
        this.$dictionaryContainer = $(param.dictionaryContainer);
    ...
    SiteController.prototype = {
        ...
        initNavigation: function () {
            ...
            this.$navTrainings.on("click", function (evt) {
                setCurrent( this );
                evt.preventDefault();
                that.trainings.displayTrainings();
                if (that.isMobile == true) {
                    that.menuHandler();
                }
            });
        ...
        checkInvalidSession: function (responseData) {
            if (responseData.responseText.indexOf("ERR_INV_AUTH") > -1) {
                localStorage.removeItem('sessionId');
                siteController.user.displayLoginPage();
            }
        }
    }
