(function () {
    ...
    Assets.prototype = {
        ...
        generateAssetsLayout: function (asset) {
            return [
				"<tr>",
					"<th class='assetName'>" + asset.Asset + "</th>",
					"<td class='farmQty'><span>",
						asset.CurrentQuantity,
						"</span><button class='button small add' data-role='none' data-assetname='" + asset.Asset + "' data-curval='" + asset.CurrentQuantity + "' data-assetid='" + asset.AssetId + "'></button>",
					"</td>",
				"</tr>"
			].join("");
        },
        ...
        generateUpdateAssetForm: function(curval, assetId, assetName) {
            return "<form id='frmUpdateAsset'> \
                        ...
                        <label>Count</label><br /> \
                        <input type='text' id='assetUpdateCount' data-curval='" + curval + "' value='" + curval + "' /><br /> \
                        <label>Price</label><br /> \
                        <input type='text' id='assetUpdatePrice' /><br /> \
