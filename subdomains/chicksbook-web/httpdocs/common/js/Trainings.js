(function () {
    ...
    Trainings.prototype = {
        ...
        displayTrainings: function(){
			...
			SiteController.PAGE_CLASS_NAME = "training-page";
        ...
        attachTrainingsClicks: function () {
            ...
            this.$trainingsList.on("click", "li", function () {
                ...
                if ($(this).hasClass(that.compTrainingClass)) {
                    $("#modalContent").append("<div class='buttons modalButtonsHolder'><a href='#' class='button' id='cancelModal'>Cancel</a></div>");
                }
                else {
                    var trainingId = $($(this).find("span")[0]).text();
                    $("#modalContent").append("<div class='buttons modalButtonsHolder'><a href='#' id='markAsDone' class='button primary tsk' data-trainingid='"
                            + trainingId + "'>Mark As Done</a><a href='#' class='button' id='cancelModal'>Cancel</a></div>");
                }
                that.$modal.show();
            });
