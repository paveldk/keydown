(function () {
    ...
    Farm.prototype = {
        ...
        loadFarm: function () {
            ...
            $.ajax({
                ...
                success: function (r, textStatus, jqXHR) {
					...
					that.$farmContainer.append("<table class='grid'><tbody></tbody></table>");

                    for (i = 0; i < r.length; i++) {
                        that.$farmContainer.find("table tbody").append(that.generateFarmLayout(r[i]));
                    }

                    that.$farmContainer.append(
						[
							"<div class='buttons'>" +
								"<a href='#' class='button' id='btnAddNewPet'>Add New Pet</a>"+
							"</div>"
						].join()
					);
        ...
        generateFarmLayout: function (farm) {
            return [
				"<tr>",
					"<th class='petName' colspan='6'><h2 class='sub'>" + farm.PetName + "<button data-petid='" + farm.Id + "' class='button small more btnMoreInfo'></button></h2></th>",
				"</tr>",
				"<tr>",
					"<th><span class='farmAsset'>Pet Count</span></th>",
					"<td>",
						"<span class='farmQty'>" + farm.Count + "</span>",
						"<button class='button small edit' data-role='none' data-asset='P' data-curval='" + farm.Count + "' data-petid='" + farm.Id + "'></button>",
					"</td>",
					"<th><span class='farmAsset'>Eggs In Stock</span></th>",
					"<td>",
						"<span class='farmQty'>" + farm.EggsInStock + "</span>",
						"<button class='button small edit' data-role='none' data-asset='E' data-curval='" + farm.EggsInStock + "' data-petid='" + farm.Id + "'></button>",
					"</td>",
					"<th><span class='farmAsset'>Eggs Hatching</span></th>",
					"<td>",
						"<span class='farmAsset'></span>",
						"<span class='farmQty'>" + farm.EggsHatching + "</span>",
						"<button class='button small edit' data-role='none' data-asset='H' data-curval='" + farm.EggsHatching + "' data-petid='" + farm.Id + "'></button>",
					"</td>",
				"</tr>"
			].join("")
        },
