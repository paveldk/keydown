// Simple Simulator for WebGL (based on Three.js) KeyDownTM
Sim = {};
...
Sim.App.prototype.addToIntersected = function (obj) {
    ...
    //            this.buildIntersectList(obj.children, list);
    //        }
    //    }
    this.intersectedList.push(obj);
}
    ...
    if (this.clickedObject && this.clickedObject.handleMouseMove) {
        ...
        if (this.overObject != oldObj) {
            ...
            if (this.overObject) {
                ...
                //  console.log(this.overObject.handleMouseOver);
...
Sim.App.prototype.objectFromMouse = function (pagex, pagey) {
    ...
    //var ray1 = new THREE.Ray(this.camera.position, vector.subSelf(this.camera.position).normalize());

    var intersects = ray.intersectObjects(this.intersectedList, true);
    //  console.log(intersects);
    //  console.log(this.intersectedList)
