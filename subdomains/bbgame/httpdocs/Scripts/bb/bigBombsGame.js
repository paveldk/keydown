        ...
        nextStage: function () {
            ...
            switch(currentStage)
            {
                case 0:
                    $.smallBox({
                        title: "Build Stage",
                        content: "First Player Build stage.",
                        timeout: 2000,
                        color: "#d24726"
                    });
                ...
                case 1:
                    $.smallBox({
                        title: "Build Stage",
                        content: "Second Player Build stage.",
                        timeout: 3000,
                        color: "#d24726"
                    });
                ...
                case 2:
                    $.smallBox({
                        title: "Attack Stage",
                        content: "First Player is Attacking now.",
                        timeout: 2000,
                        color: "#d24726"
                    });
                    that.$userOnMove.text(that.creatorName);
                ...
                case 3:
                    ...
                    $.smallBox({
                        title: "Attack Stage",
                        content: "Second Player is Attacking now.",
                        timeout: 2000,
                        color: "#d24726"
                    });
                    that.$userOnMove.text(that.guestName);
                ...
                case 4:
                    $.smallBox({
                        title: "Collect Stage",
                        content: "Players collect income.",
                        timeout: 2000,
                        color: "#d24726"
                    });
                        ...
                        switch (that.currentSelectedUnit) {
                            case "mine":
                                ...
                                if (!that.playerHasEnoughMoney('1')) {
                                    that.notifyUserFromGame('Not enough money for building a mine!')
                                    return;
                                }
                                that.minesMatrix[ri][rj].shape.stop();
                            ...
                            case "chicken":
                                if (!that.playerHasEnoughMoney('c')) {
                                    that.notifyUserFromGame('Not enough money for building so many chickens!')
                                    return;
                                }
                                if (that.unitsMatrix[ri][rj] == '1') {
                                    that.notifyUserFromGame('Invalid position!');
                            ...
                            case "pig":
                                if (!that.playerHasEnoughMoney('p')) {
                                    that.notifyUserFromGame('Not enough money for building so many pigs!')
                                    return;
                                }
                                that.pigsMatrix[ri][rj].shape.stop();
                            ...
                            case "bomb":
                                if (!that.playerHasEnoughMoney('b')) {
                                    that.notifyUserFromGame('Not enough money for building that bomb!')
                                    return;
                                }
        ...
        createGame: function (creator, groupName, random) {
            ...
            that.bb.client.notifyPlayerWrongGameID = function () {
                $.MetroLoading({
                    ...
                    content: "Game with that ID does not exist. You will be redirected.",
                    timeout: 5000
